<template>
  <div class="songs-list">
    ...
    <div v-for="song in uploadedSongs" :key="song.name" class="songs-list-element" >
...
<script>
export default {
  name: "UploadedSongList",
  computed: {
    uploadedSongs() {
      console.log(this.$store.getters.getUploadedAlbums)
      return this.$store.getters.getUploadedAlbums;
    }
  },
  methods: {
    ...
    changeNowPlaying: async function (song, full) {
      ...
      let mp3_src = "http://localhost:3000/mp3up/" + path_to_mp3
